# AtlasSiteConfig class
setClass( "AtlasSiteConfig", slots = c( config = "list" ) )

#############
# Generics

setGeneric( "site_config_list", function( object ) standardGeneric( "site_config_list" ) )

##########
# Methods

# constructor
setMethod( "initialize", "AtlasSiteConfig", function( .Object ) {
    ...
    siteConfig <- yaml.load.file( atlasSiteConfigFile )
    
    # Add the site config to the object.
    .Object@site_config_list <- siteConfig

    return( .Object )
})

# site_config_list getter.
setMethod( "site_config_list", "AtlasSiteConfig", function( object ) object@site_config_list )
