...
experiments. Protocols describing how the data was generated is contained within
...
returns a list where each experiment summary is stored under its ArrayExpress
accession.

```{r}
myAccessions <- c( "E-MTAB-3007", "E-GEOD-16567" )
mySummaries <- getAtlasData( myAccessions )
mySummaries
```

Each experiment summary in the list is either a *RangedSummarizedExperiment* or
an *ExpressionSet* (see above).
